...
namespace YADA.Test
{
    ...
    public class RuleEngineTests
    {
        ...
        {
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Approve) }, new[] { new DependencyRule((s, d) => DependencyRuleResult.Approve) });
        ...
        public void Analyse_ValidTypesWithoutDependency_Success()
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Approve) }, new IDependencyRule<ITypeDescription, IDependency>[0] { });
        ...
        public void Analyse_SetOfTypes_TypeFilterCalledForAnyType()
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(t => { list.Add(t); return DependencyRuleResult.Approve; }) }, new[] { new DependencyRule((s, d) => DependencyRuleResult.Approve) });
        ...
        public void Analyse_SetOfTypesOneWithExactlyDependency_DependencyFiltersCalled()
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Approve) }, new[] { new DependencyRule((s, d) => { calls.Add(new Tuple<ITypeDescription, IDependency>(s, d)); return DependencyRuleResult.Approve; }) });
        ...
        public void Analyse_FirstTypeRuleSkipsType_NoOtherTypeRuleCalledForThisType() 
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Skip), new TypeRule(_ => throw new NotImplementedException()) }, new[] { new DependencyRule((s, d) => { throw new NotImplementedException(); }) });
        ...
        public void Analyse_RejectType_Failed()
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Reject) }, new[] { new DependencyRule((s,v) =>  DependencyRuleResult.Ignored )});
            var result = sut.Analyse(input, new FeedbackCollector());
        ...
        public void Analyse_RejectType_NoOtherTypeRuleExecutedForThisType()
        {
            ...
            var sut = new RuleEngine(new[] { typeRejectingRule.Object, additionalTypeRule.Object }, new[] { Mock.Of<IDependencyRule<ITypeDescription, IDependency>>() });
            var result = sut.Analyse(input, new FeedbackCollector());
        ...
        public void Analyse_OneRejectOneApprovedType_ApplyCalledAtAllRulesForApprovedType()
        {
            ...
            var sut = new RuleEngine(new[] { typeRejectingRule.Object, additionalTypeRule.Object }, new[] {dependencyRule.Object});
            var result = sut.Analyse(input, new FeedbackCollector());
        ...
        public void Analyse_RejectType_NoOtherDependencyRuleExecutedForThisType()
        {
            ...
            var sut = new RuleEngine(new[] { new TypeRule(_ => DependencyRuleResult.Reject) }, new[] { new DependencyRule((s,v) =>  throw new NotImplementedException() )});
            var result = sut.Analyse(input, new FeedbackCollector());
